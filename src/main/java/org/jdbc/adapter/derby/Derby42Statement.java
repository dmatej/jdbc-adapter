 ...
 */
public class Derby42Statement extends Jdbc42Statement {

  public Derby42Statement(final Statement statement, final ConnectionWrapper parentConnection) {
  ...
  public ResultSetWrapper wrap(final ResultSet resultSet) {
    ...
    return new Derby42ResultSet(resultSet, this);
  }
